...
name(bedroom_closet, "Your Bedrooms Closet").
...
name(coat,"Dr. Sundbergs lab coat").
...
name(cooked_spaghetti, "Lots a Spaghetti").
...
name(lost_homework,"Some students lost geometry homework.").
...
name(roommate_room,"Your dormmates room").
name(sauce, "Marinara Sauce").
name(secret_lab,"Dr. Sundbergs Secret Lab").
...
short_desc(bedroom,"your bedroom - complete with dirty laundry and heaps of old homework, the sad remains of many hard fought battles waged over Dr. Sundbergs homework").
...
short_desc(engr,"A large building with many classrooms, youre surprised to see students wandering the halls at this time.").
short_desc(eslc_north,"You are on the north side of the ESLC.").
short_desc(eslc_south,"You are on the south side of the ESLC.").
short_desc(figurine,"Your roommates alien figurine sitting atop a shelf.").
...
short_desc(tunnels_east,"The underground tunnels are a confusing place.  I hope you dont get lost.").
short_desc(tunnels_north,"The underground tunnels are a confusing place.  I hope you dont get lost.").
short_desc(tunnels_west,"The underground tunnels are a confusing place.  I hope you dont get lost.").
...
long_desc(avenue,"A myriad of people walk every which way along the avenue.  All are seemingly unaware of their imminent destruction at Dr.Sundbergs hand.").
long_desc(bedroom,"The college dorm room where you currently reside. These walls have witnessed more late night study sessions than you care to consider. The bed is soaked with the dried tears of uncounted tests failed. Fortunately, the building is aired frequently enough that you cant still smell the years of dirty laundry that have sat in the closet.").
...
long_desc(coat,"A spiffy looking lab coat. The pockets are lined with some kind of residue from Dr. Sundbergs experiments. It smells like aliens... Gross!").
...
long_desc(figurine,"Your roommates alien figurine.  Theyve been obsessed with aliens since you first met.  You always wondered why, but after reading that note about Dr.Sundberg, it is all beginning to make sense.").
...
long_desc(gas_lab,"Founded in 1976, the Get Away Special team is a student-driven, space research team which has established and upheld Utah State Universitys reputation as the university that has flown more experiments into space than any other university in the world.").
...
long_desc(key,"You feel the alien energy flowing from the key. Could it be? Have you been chosen as the next wielder of the Keyblade? You hold out your hand to the side, but sadly, nothing happens. Its just a normal alien key....").
long_desc(kitchen,"There are an assortment of pots and pans. Someone is cooking your favorite food but it doesnt look like they are going to share.").
long_desc(kitchen_trashcan,"A black, round, plastic container lined with a flexible bag. Its as generic as can be, lacking any logo or branding.").
long_desc(large_disk,"a large disk on the bottom of the red pylon. You worked out today so if there isnt anything on top of it, you could probably move it...").
...
long_desc(medium_disk,"a medium sized disk in between the small and large disks on the red pylon. It looks like you can move it if there isnt anything on top of it...").
long_desc(movie, "Stars Will Smith and Tommy Lee Jones as members of a secret task force dedicated to protecting earth from alien invaders and earths inhabitants from any knowledge of aliens. Your dormmate must have been conducting research").
long_desc(note,"In the handwriting of your roommate is hastily scrawled: 'Youve got to help.  Dr. Sundberg is an alien and wants to take over the world.  I think he is on to me, you are the only hope left! Try to find out what he is doing with the green beam.'").
...
long_desc(old_main,"The building has four floors, and is the location of much pain during the Evil Dr. Sundbers class.  Few can navigate their way to the 4th floor where dreams become computer programs.").
...
long_desc(roommate_room,"Not quite as messey as yours, your roommates room has a mini fridge stocked with Dr. Pepper. You see the sun shining through the locked window. ").
long_desc(sauce, "Marinara Sauce").
long_desc(secret_lab,"You notice your surroundings are almost identical to the cartoon Dexters laboratory. There are many experiments being done around the room.").
...
long_desc(ser_basement, "Behind every door is another labrotory. The hallways are strewn with machines that appear to belong to a mad scientist although its probably only Dr. JR Dennison").
...
long_desc(tower_of_pizza_boxes,"Dominos, Pizza-Hut, Little Ceasers and more. All are rendered equal in this towering graveyard of cardboard.").
long_desc(tsc,"This massive building is the perfect place to go to spend way too much money on overpriced things... Youll find students eating, studying, socializing, and lamenting their massive student debts.").
long_desc(tsc_patio,"An open area with birds chirping and hipsters drinking their coffee. You wont find any CS majors here as theyre all in cavedwelling in Old Main.").
...
long_desc(money, "A couple of dollars found on your dresser. Youve heard it can be exchanged for goods and services.").
